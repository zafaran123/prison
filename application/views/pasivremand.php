						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title" style="color:red">Control Panel: / Released Remande Prisoner</h3>
									<div class="right">
								...
								<div class="panel-footer">
									<div class="row">
										...
										<div class="col-md-6 text-right"><a href="#" class="btn btn-primary">View All Remande</a></div>
									</div>
								</div>
							</div>
